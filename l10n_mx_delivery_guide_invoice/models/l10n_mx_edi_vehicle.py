...
class Vehicle(models.Model):
    _name = 'l10n_mx_delivery_guide_invoice.vehicle'
    ...
    transport_insurer = fields.Char('Insurance Company',
                                    help='The name of the insurer that covers the liability risks of the vehicle')
    ...
    trailer_ids = fields.One2many(
        comodel_name='l10n_mx_delivery_guide_invoice.trailer',
        inverse_name='vehicle_id',
        string='Trailers',
        help='Up to 2 trailers used on this vehicle')
    figure_ids = fields.One2many(
        comodel_name='l10n_mx_delivery_guide_invoice.figure',
        inverse_name='vehicle_id',
        ...
        for vehicle in self:
            ...
            if not operators:
                raise ValidationError(
                    _("The vehicle intermediaries must contain at least one intermediary of type: Operator"))
...
class Figure(models.Model):
    _name = 'l10n_mx_delivery_guide_invoice.figure'
    _description = 'MX EDI Vehicle Intermediary Figure'

    vehicle_id = fields.Many2one('l10n_mx_delivery_guide_invoice.vehicle')
    ...
    part_ids = fields.Many2many('l10n_mx_delivery_guide_invoice.part', 'guide_invoice_part_rel', string='Parts')


class Part(models.Model):
    _name = 'l10n_mx_delivery_guide_invoice.part'
...
class Trailer(models.Model):
    _name = 'l10n_mx_delivery_guide_invoice.trailer'
